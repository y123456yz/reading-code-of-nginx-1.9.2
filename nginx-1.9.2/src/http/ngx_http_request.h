...
#if (NGX_HTTP_CACHE)
    ngx_http_cache_t                 *cache;//ngx_http_file_cache_new中赋值r->caceh = ngx_http_cache_t
#endif
...
*/
    ...
    //ngx_http_copy_aio_handler中置1，handler ngx_http_copy_aio_event_handler执行后，会置回到0

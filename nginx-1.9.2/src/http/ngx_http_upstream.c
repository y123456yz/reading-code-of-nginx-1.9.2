...
/*
    ...
    5) upstreamÄ£¿é½«»á¼ì²é5.1.3½ÚÖĞ½éÉÜ¹ıµÄresolved³ÉÔ±£¬Èç¹ûÓĞresolved³ÉÔ±µÄ»°£¬¾Í¸ù¾İËüÉèÖÃºÃÉÏÓÎ·şÎñÆ÷µÄµØÖ·r->upstream->peer³ÉÔ±¡£
...
ngx_http_upstream_send_request(ngx_http_request_t *r, ngx_http_upstream_t *u,
    ngx_uint_t do_write) //ÏòÉÏÓÎ·şÎñÆ÷·¢ËÍÇëÇó
{
    ngx_int_t          rc;
    ngx_connection_t  *c;
...
//¸Ãº¯Êı´¦ÀíµÄÖ»ÊÇºó¶Ë·Å»Ø¹ıÀ´µÄÍøÒ³°üÌå²¿·Ö
    ...
    if (u->peer.connection) {
        ...
        if (u->cacheable) { //ÊÇ·ñÒª»º´æ£¬¼´proxy_no_cacheÖ¸Áî  
            ...
            } else if (p->upstream_eof) { //±¾´ÎÒÑ¾­°ÑÄÚºË»º³åÇøÊı¾İ¶ÁÈ¡Íê±Ï
